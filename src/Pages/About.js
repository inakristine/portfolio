...
export default function contact(props) {
  return (
    <div>
      ...
      <Paragraph text='I have a great love for learning new skills and making products of value to my clients. As a classic nerd, I don’t like to put my unresolved issues aside. I am efficient, conscientious, educated and have a lot of loyalty and good work ethic to offer.' />
      ...
      <Paragraph text='Ideally, I want to work in a place where the working environment is good and where I can go to work and be inspired by good colleagues. A positive and inspiering working environment, where I can evolve as an employee, and feel secure and safe is more important to me than fancy perks and high salaries.' />
    </div>
  );
}
