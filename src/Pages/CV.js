...
export default function home(props) {
  ...
  return (
    <div>
    <Title when='Yrkeserfaring:' what='Stilling:' where='Bedrift:' />
    ...
    <Title when='Education:' what='Field:' where='School:' />
    ...
    <Content when='Adobe InDesign,Photoshop og Illustrator' what='Mac and PC' where='Advanced' />
